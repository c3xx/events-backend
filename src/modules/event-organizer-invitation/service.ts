...
export async function sendInvitation(
    ...
    const organizer = await repository.findOrganizerByOrganization(eventId, clubHeadRole.organizationId,);
    if (organizer == null) {
    ...
    const existingPendingInvite = await repository.findPendingInvitation(eventId, input.recipientOrganizationId);
